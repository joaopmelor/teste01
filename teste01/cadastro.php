...
<div class="form">
        <form action="processa.php" method="POST">
            <fieldset>
                ...
                <br><br>
                <div class="inputForm">
                    <input type="text" name="nome_social" id="nome_social" class="user">
                    <label for="nome_social" class="label-input">Nome Social</label>
                </div>
                <br><br>
                <div class="inputForm">
                    <input type="text" name="cpf" id="cpf" class="user" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" placeholder="xxx.xxx.xxx-xx" required>
